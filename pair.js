    ...
    let num = req.query.number;
     ...
     try {
            ...
            Pair_Code_By_Brasho_Kish.ev.on("connection.update", async (s) => {
               ...
               let session = await Pair_Code_By_Brasho_Kish.sendMessage(Pair_Code_By_Brasho_Kish.user.id, { text: 'BLADE-MD;;;' + b64data });
